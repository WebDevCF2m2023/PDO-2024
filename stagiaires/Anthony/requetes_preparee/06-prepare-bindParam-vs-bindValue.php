...
<code>
   ...
   echo $query->rowCount()."<br>";
    ?>
    <h2>bindValue</h2>
    <p>Met en paramètre une variable, une valeur ou le retour d'une fonction qui ne sera pas gardée comme référence ($var),
cet élément doit être redéclaré à chaque fois
    </p>
    <?php
 $query = $PDOConnect->prepare("SELECT * FROM countries WHERE id BETWEEN ? AND ?");
 $prems=5;$dems =15;
